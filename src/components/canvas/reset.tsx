...
const Reset = ({
  ...
  return (
    <div className="absolute bottom-4 left-4 z-[1000] flex cursor-[url('/shared/customcursor.svg'),auto] select-none">
      <button
      ...
      >
        <Image src="/shared/reset.svg" alt="Reset" width={18} height={18} />
      </button>
    </div>
  );
};
