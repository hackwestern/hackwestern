...
const Toolbar = ({ zoom, panOffset }: { zoom: number; panOffset: Point }) => {
  ...
  return (
    <div
      className="absolute left-4 top-4 z-[1000] cursor-default select-none rounded-[10px] border-[1px] border-border bg-offwhite p-2 font-mono text-xs text-heavy shadow-md md:text-sm"
