...
export default function Envelope() {
  ...
  return (
    <div className="flex flex-col gap-4 items-center justify-center rotate-[8deg]">
      <div
        className="relative -mt-[150px] h-[375px] w-[450px]"
      ...
      >
        ...
        {/* Back fold */}
        <motion.div
          className="absolute bottom-0 right-0 z-0 h-0 w-0"
          style={{
            width: "450px",
            height: "188px",
        ...
        {/* Left fold */}
        <motion.div
          className="absolute bottom-0 z-10 h-0 w-0"
          style={{
            width: "275px",
            height: "188px",
        ...
        {/* Bottom fold */}
        <motion.div
          className="absolute bottom-0 right-0 z-20 h-0 w-0 shadow-lg"
          style={{
            width: "450px",
            height: "113px",
