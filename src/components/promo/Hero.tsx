...
function Hero() {
  ...
  return (
    <div>
      <div className="absolute inset-0 z-0 h-full w-full bg-hw-radial-gradient opacity-100"></div>
      ...
      <div
        ref={constraintRef}
        className="z-2 absolute inset-0 flex h-full w-full items-center justify-center"
      >
