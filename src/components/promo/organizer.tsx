  ...
  return (
    <div className="bg-gradient-to-b from-[#9D72D5] to-[#5A2F92] pb-16 pt-12 text-3xl lg:py-14">
      ...
      <div className="w-full overflow-hidden pt-8">
        <div className="-mb-1 ml-24 flex animate-organizer-slide-small gap-8 p-4 hover:[animation-play-state:paused] md:animate-organizer-slide xl:gap-16 2xl:gap-20 3xl:gap-28 4xl:gap-36">
