...
function Dots() {
  return (
    <div className="absolute inset-0 h-full min-h-screen w-full bg-[radial-gradient(#776780_1.5px,transparent_1px)] opacity-40 [background-size:20px_20px] md:h-full" />
  );
}
