    ...
    >
      ...
      <div className="mx-4 flex h-auto justify-between overflow-clip sm:invisible sm:h-0">
        ...
        <div className="flex gap-2">
          <div
            className={`rounded-2xl ${menuVisible && "border border-primary-600"} bg-primary-300 p-2.5`}
          ...
          <div
            className={`rounded-2xl ${menuVisible && "border border-primary-600"} bg-primary-300 p-2.5 font-semibold text-primary-600`}
          >
            {stepName}
          </div>
        </div>
