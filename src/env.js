...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    // WALLET_R2_ACCESS_KEY_ID: process.env.WALLET_R2_ACCESS_KEY_ID,
    // WALLET_R2_SECRET_ACCESS_KEY: process.env.WALLET_R2_SECRET_ACCESS_KEY,
    // WALLET_R2_ENDPOINT: process.env.WALLET_R2_ENDPOINT,
    // WALLET_R2_BUCKET_NAME: process.env.WALLET_R2_BUCKET_NAME,
    // WALLET_R2_PUBLIC_BASE_URL: process.env.WALLET_R2_PUBLIC_BASE_URL,
