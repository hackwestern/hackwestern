...
import { CanvasComponent, canvasHeight, canvasWidth } from "~/components/canvas/canvas";
  ...
  return (
    ...
    <main className="flex h-svh max-h-svh flex-col items-center bg-primary-50">
      ...
      <div className="relative flex w-full flex-grow flex-col items-center md:flex-row">
        ...
        <div
          id="left-panel"
          className="w-[20%] z-10 flex flex-grow flex-col items-center justify-center gap-4 bg-primary-100 p-9 pt-12 text-center md:h-full lg:max-w-xl"
        />
        <div
          id="right-panel"
