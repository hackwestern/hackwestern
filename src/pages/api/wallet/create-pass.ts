...
const NEXT_PUBLIC_APP_URL = env.NEXT_PUBLIC_APP_URL; // Used for JWT 'origins'

// Fixed variable declaration - using let instead of const
...
if (!serviceAccountCreds && GOOGLE_APPLICATION_CREDENTIALS) {
  try {
