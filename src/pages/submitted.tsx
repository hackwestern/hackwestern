...
export default function Submitted() {
  ...
  return (
    <div className="flex h-svh flex-col">
      ...
      <div className="flex flex-grow items-center justify-center bg-hw-linear-gradient-day">
        <div className="flex max-w-screen-sm flex-col items-start gap-2 rounded-lg border-primary-300 bg-violet-100 p-10 ">
