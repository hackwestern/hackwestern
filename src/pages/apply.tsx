          ...
          >
            ...
            <div className="z-10 flex flex-col items-center justify-center overflow-auto">
              <div className="h-full w-full space-y-4">
                <div className="h-md flex w-lg flex-col justify-start space-y-8 rounded-md bg-white px-8 py-8 shadow-lg sm:w-xl md:h-[75vh] md:px-12 md:py-12 lg:h-[70vh] lg:w-3xl 2xl:h-[65vh] 2xl:w-4xl 3xl:h-[60vh] 3xl:w-6xl 4xl:w-7xl">
