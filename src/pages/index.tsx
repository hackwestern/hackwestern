    ...
    <>
      ...
      <main>
        <div className="relative h-screen flex-col items-center justify-center overflow-x-clip bg-hw-radial-gradient">
          ...
          <div>
            <div className="absolute -bottom-72 left-0 z-30 h-[130%] w-full">
              <Image
            ...
            <div className="absolute -bottom-24 right-0 z-30 h-[120%] w-full ">
              <Image
            ...
            <div className="absolute bottom-0 left-0 z-30 h-full  w-[50%] md:h-full md:w-[30%]">
              <Image
            ...
            <div className="absolute -bottom-32 right-0 z-30 h-full w-[50%] md:h-full md:w-[30%]">
              <Image
        ...
        <div className="bg-hw-linear-gradient relative h-screen flex-col items-center justify-center overflow-hidden">
          {/* Grain Filter */}
          <div className="absolute left-0 top-0 h-full w-full">
            <Image
              className="opacity-20"
